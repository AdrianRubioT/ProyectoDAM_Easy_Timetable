...
public class CrearTarjeta extends JDialog {
	 ...
	 * @param controlRadio 
	 */
	public CrearTarjeta(JFrame padre, boolean modal, ControlRadioButon controlRadio) {
		super(padre, modal);
	 ...
	 */
	public Tarjeta getTargeta() {
		return new Tarjeta( lin1.getText(), lin2.getText(), lin3.getText(), lin4.getText(), controlRadio );
	}
